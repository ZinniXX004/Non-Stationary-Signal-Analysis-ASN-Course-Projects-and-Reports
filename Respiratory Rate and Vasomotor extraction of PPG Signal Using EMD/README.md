...
$$x[n] = \sum_{k} cA_{j,k} \phi_{j,k}[n] + \sum_{j} \sum_{k} cD_{j,k} \psi_{j,k}[n]$$
...
*Where* $$IMF_i(t)$$ *is the* $$i$$*-th intrinsic mode function and* $$r_n(t)$$ *is the final residue.*
